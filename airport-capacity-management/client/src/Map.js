...
const markers = [
  { position: { lat: 40.8583, lng: -74.0615 }, title: "KTEB", status: "Overcapacity" },
  { position: { lat: 41.0683, lng: -73.7087 }, title: "KHPN", status: "Overcapacity" },
  { position: { lat: 26.6857, lng: -80.0928 }, title: "KPBI", status: "Reaching Capacity" },
  { position: { lat: 36.0831, lng: -115.1482 }, title: "KLAS", status: "Overcapacity" },
  { position: { lat: 42.3656, lng: -71.0096 }, title: "KBOS", status: "Undercapacity" },
  { position: { lat: 43.6088, lng: -110.7376 }, title: "KJAC", status: "Undercapacity" },
  { position: { lat: 41.7868, lng: -87.7522 }, title: "KMDW", status: "Overcapacity" },
  { position: { lat: 33.6204, lng: -111.9153 }, title: "KSDL", status: "Reaching Capacity" },
  { position: { lat: 32.8438, lng: -96.8485 }, title: "KDAL", status: "Overcapacity" },
  { position: { lat: 39.6423, lng: -106.917 }, title: "KEGE", status: "Undercapacity" },
];
